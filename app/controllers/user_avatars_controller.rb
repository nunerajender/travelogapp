class UserAvatarsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @user_avatar.save
        ...
        format.json {render :json => @user_avatar}
      else
  ...
  def update
    respond_to do |format|
      if @user_avatar.update(user_avatar_params)
        format.html { redirect_to @user_avatar.store_setting, notice: 'User avatar was successfully updated.' }
  ...
  private
    ...
    def user_avatar_params
      params.require(:user_avatar).permit(:profile_id, :avatar)
    end
end
